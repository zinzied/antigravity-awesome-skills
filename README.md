<!-- registry-sync: version=10.2.0; skills=1421; stars=33408; updated_at=2026-04-16T14:29:36+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,421+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,421+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,421+ skills across development, testing, security, infrastructure, product, and marketing.
...
If you want a faster answer than "browse all 1,421+ skills", start with a tool-specific guide:
